...
def peak(pars, x, frange=None, key=None):
    ...
    pdftime,xnorm = pdfs.nnf(rv,normrange=frange,data=x[1])
...
def background(x, frange=None):
    ...
    pdfvals = height0*height1*np.ones(len(x[0]))
...
#Restricted 
pars = {}
pars["peak0"] = {"number":Parameter(2250,(0,5000)), "mean":Parameter(8.9,(8.5,9.1)), "sigma":Parameter(0.25,(0.10,1)), "lifetime":Parameter(244,(240,250))}
pars["peak1"] = {"number":Parameter(600,(0,5000)), "mean":Parameter(9.7,(9.6,9.8)),  "sigma":Parameter(0.15,(0.05,.3)), "lifetime":Parameter(271,(260,290))}
pars["peak2"] = {"number":Parameter(2200,(0,10000)), "mean":Parameter(10.3,(10.1,10.32)),  "sigma":Parameter(0.05,(0.01,.08)), "lifetime":Parameter(271,(260,280))}
pars["peak3"] = {"number":Parameter(3400,(0,10000)), "mean":Parameter(10.39,(10.3,10.5)),  "sigma":Parameter(0.06,(0.01,.07)), "lifetime":Parameter(271,(260,280))}
...
plt.subplot(1,2,2)
binwidth=(1238/100)
plt.hist(data[1],bins=100,range=(0,1238),alpha=0.2)
lch.hist_err(data[1],bins=100,range=(0,1238),alpha=0.2)
#plt.show()

#exit()

#ysig = pars['peak0']['number'].value*peak(pars,[xpts0,xpts1],frange=(0,1238),key="peak0")
ysig = peak(pars,[xpts0,xpts1],frange=(0,1238),key="peak0")
#plt.figure()
#y = pars['peak0']['number'].value*ysig[1][1]*1238/100
y = 6000*ysig[1][1]*(1238/100.)
#print(y)
plt.subplot(1,2,2)
plt.plot(xpts1,y)
